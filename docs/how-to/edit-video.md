...
Use a [current source installation](use-current-source.md) containing the [static-overlay timing correction](https://github.com/hraness/slopcamera/commit/bd011ec10854d34aacd9a318cacaf5ffb4d52b9d). These outputs depend on that correction keeping the SVG visible through the final frame. The correction is absent from v3.3.1; check a later verified release's contents before substituting the release CLI.
