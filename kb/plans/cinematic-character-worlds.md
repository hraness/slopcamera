...
- **Status:** Implemented locally — six pure planning operations registered, `cinematic-world` built-in workflow, inert recipe-pack contract, and coding-agent authoring skill green on focused suites; full gate in progress
- **Depends on:** Phase 12
