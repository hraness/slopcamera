...
- **Status:** Implemented locally — stale command/capability claims reconciled with source, cinematic-world and extension-architecture docs added across repo and site surfaces, web check green; PR pending
