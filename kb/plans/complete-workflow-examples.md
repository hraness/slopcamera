...
Delivered main 4cdfb0b is integrated, including the verified v3.3.2 installation surface. The next source candidate is v3.3.3. The workflow-examples browser baseline is being independently refreshed to exact revision 4cdfb0b3cc9fc23707549b0ee7a0e8cb1179c45b, tree 3148096494b4911f4660d55d5a7840c0e7e53fb5, using schema six. The prior 437a530 baseline and its evidence remain retained. Release parity covers 17 MCP tools, six portable operation codes and eight built-in workflows. Each earlier example retains its actual execution version and source identity. Later renderer corrections need the next verified release.
