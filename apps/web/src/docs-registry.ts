...
export const docPages: readonly DocsPage[] = [
  ...
  { slug: "reference/vectorization", title: "Local raster-to-SVG vectorization",
    description: "The checksum-pinned VTracer profile: supervision, fidelity measurement, inert SVG, provenance, and platform bounds.",
    section: "reference" },
  ...
  { slug: "reference/native-engines", title: "Native engines: Blender, CadQuery, and Manim",
    description: "The studio adapter contract: retained hash-bound bundles, explicit runtimes, trusted-code authorization, and verified outputs.",
    section: "reference" },
  ...
  { slug: "explanation/use-cases", title: "Slopcamera use cases",
    ...
    section: "explanation" },
  { slug: "explanation/choose-an-interface", title: "Choose an interface: Skill, CLI, SDK, or MCP",
