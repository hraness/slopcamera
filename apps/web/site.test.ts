...
describe("static Slopcamera site", () => {
  ...
  test("release installation advertises the exact canonical archive beside the source path", async () => {
    expect(publishedRelease).toEqual({ version: "3.3.2", releaseUrl: "https://github.com/hraness/slopcamera/releases/tag/v3.3.2" })
    expect(Object.isFrozen(publishedRelease)).toBe(true)
    expect(publishedArchiveUrl).toBe("https://github.com/hraness/slopcamera/releases/download/v3.3.2/hraness-slopcamera-3.3.2.tgz")
