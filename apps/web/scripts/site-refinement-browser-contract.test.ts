...
test("literal fixtures admit only the six reviewed authored islands",()=>{
 ...
 expect(refinementInstallCommand.split("\n")).toEqual(["bun add --global https://github.com/hraness/slopcamera/releases/download/v3.3.3/hraness-slopcamera-3.3.3.tgz","slopcamera skill install --target agents"])
