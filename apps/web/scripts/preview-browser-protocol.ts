...
export type WorkerProtocolProfile = "workflow-examples-v1" | "release-copy-v1" | "portfolio-surfaces-v1" | "portfolio-surfaces-v2" | "portfolio-surfaces-v3"
function profiledProtocolLimit(profile: WorkerProtocolProfile): number {
  assert.ok(profile === "workflow-examples-v1" || profile === "release-copy-v1" || profile === "portfolio-surfaces-v1" || profile === "portfolio-surfaces-v2" || profile === "portfolio-surfaces-v3", "Unknown worker protocol profile")
  return profile === "workflow-examples-v1" || profile === "release-copy-v1" ? examplesWorkerProtocolLimit : portfolioWorkerProtocolLimit
}
