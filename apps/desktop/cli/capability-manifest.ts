...
const capabilityModules = Object.freeze([
  ...
  defineSlopcameraCapabilityModule({
    ...
    description: "Editable spatial scenes, calibrated cameras, bounded geometry, rendered evidence, and closed effects contracts.",
    ...
    toolNames: ["audit_scene", "check_scene", "diff_scenes", "evaluate_scene", "inspect_scene"],
    trust: "local-effects",
    version: 1,
    workflowKeys: [],
  }),
